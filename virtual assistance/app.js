...
function speakThis(message) {
    ...
    else if (message.includes('play song') || message.includes('play') || message.includes('jarvis play song of')|| message.includes('play music')) {
        const searchQuery = message.replace('play song', '').replace('play music', '').replace('jarvis play song of', '').trim();
        window.open(`https://www.youtube.com/results?search_query=${searchQuery.replace(" ", "+")}`, "_blank");
        const finalText = "This is what I found on the internet regarding " + searchQuery;
        speech.text = finalText;
    }
